<?php
    ...
    if (isset($_GET['id'])) {		
        ...
        $sql = "INSERT INTO studentinfo(FirstName, LastName, Gender, Religion, DateOfBirth, PhoneNo, PresentAddress, PermanentAddress, Email, Username, Password) VALUES ('$fname', '$lname', '$gender', '$religion', '$dob', '$phone', '$preaddress', '$paraddress', '$email', '$username', '$password')";
        $qry = $ezl->query($sql);
